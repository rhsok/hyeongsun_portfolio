    ...
    return (
        <div className="w-full h-screen">
            <div className="w-full">
                <div
                    className={`relative  h-screen w-full flex flex-row justify-center opacity-90 text-white ${
                ...
                <div className="absolute top-0 left-[110px] text-white z-20  h-20 ">
                    ...
                    <div className="mt-10 p-1 grid grid-cols-4 gap-4 border border-white w-[90%] ">
                        <div>name : 라형선</div>
                ...
                <div className="relative z-20  h-screen bg-gray-200 text-black  ">
                    안녕안녕안녕안녕안녕안녕
                </div>
            </div>
        </div>
